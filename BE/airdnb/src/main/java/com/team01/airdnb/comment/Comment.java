...
public class Comment {
  ...
  public Comment update(CommentUpdateRequest commentUpdateRequest) {
    Optional.ofNullable(commentUpdateRequest.score()).ifPresent(newScore -> score = newScore);
    Optional.ofNullable(commentUpdateRequest.content())
        .ifPresent(newContent -> content = newContent);
